        ...
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              ...
              <a href="{{ route('category') }}" class="nav-link"><i class="fas fa-columns"></i> <span>Category</span></a>
              <a href="{{ route('products') }}" class="nav-link"><i class="fas fa-columns"></i> <span>Produk</span></a>
              <a href="{{ route('transactions') }}" class="nav-link"><i class="fas fa-columns"></i> <span>Transaksi</span></a>
            </li>
          </ul>
        </aside>
      </div>
